  ...
  return (
    ...
    <div className="min-h-screen flex justify-center items-center">
      <div className="flex flex-col items-center md:flex-row text-black gap-3 px-4">
        {/* Image Section */}
        <div className="flex justify-center items-center h-[150px] w-[150px] sm:h-[200px] sm:w-[200px] md:h-[250px] md:w-[250px] bg-[url('/assets/heroImg.jpeg')] bg-cover bg-[200%] bg-center border-[4px] border-white bg-white rounded-full" />
